...
const cases: Array<{ name: string; addLabel: RegExp; fields: RegExp[] }> = [
  {
    name: "Matching",
    addLabel: /add matching element/i,
    fields: [/left column items/i, /right column items/i],
  },
  {
    name: "Multiple Choice",
    addLabel: /add multiple choice element/i,
    fields: [/answer choices/i],
  },
  {
    name: "True / False",
    addLabel: /add true \/ false element/i,
    fields: [/true\/false statements/i],
  },
