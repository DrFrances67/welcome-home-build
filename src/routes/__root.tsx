...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#CF27F5" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
      { name: "apple-mobile-web-app-title", content: "Tech Savvy Teacher" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "format-detection", content: "telephone=no" },
      { title: "The Tech Savvy Teacher" },
      { name: "description", content: "The Tech Savvy Teacher Ecosystem" },
      { name: "author", content: "The Tech Savvy Teacher" },
      { property: "og:title", content: "The Tech Savvy Teacher" },
      { property: "og:description", content: "The Tech Savvy Teacher Ecosystem" },
      { property: "og:site_name", content: "The Tech Savvy Teacher" },
    ...
    links: [
      ...
      // Preconnect/preload critical fonts so the app shell paints fast on
