  ...
  head: () => ({
    meta: [
      { title: "Sign In or Create Account — The Tech Savvy Teacher" },
      {
        name: "description",
        content:
          "Sign in or create a free Tech Savvy Teacher account to access AI lesson plans, worksheets, and parent email tools.",
      },
      { property: "og:title", content: "Sign In — The Tech Savvy Teacher" },
      {
        property: "og:description",
        content:
          "Log in or create a free account to use The Tech Savvy Teacher's AI classroom tools.",
      },
