...
export const EMAIL_RECIPIENTS = [
  {
    ...
    label: "Administrator",
    icon: "🏫",
    desc: "Principal, VP, district staff",
  },
  ...
  { id: "parent", label: "Parent / Guardian", icon: "👨‍👩‍👧", desc: "Families of students" },
  {
    ...
    label: "Student",
    icon: "🎒",
    desc: "Direct messages to students — always student-friendly language",
  },
  {
    id: "grant",
    label: "Grant",
    icon: "💰",
    desc: "Foundations, donors, funders for classroom resources",
  },
];
...
export const STUDENT_GRADE_LEVELS = [
  {
    id: "k-2",
    label: "K–2",
    desc: "Ages 5–8 · very simple words, very short sentences",
    tier: "elementary",
  },
  {
    id: "3-5",
    label: "Grades 3–5",
    desc: "Upper elementary · clear & friendly",
    tier: "elementary",
  },
  {
    id: "6-8",
    label: "Grades 6–8",
    desc: "Middle school · everyday vocabulary",
    tier: "secondary",
  },
  {
    id: "9-12",
    label: "Grades 9–12",
    desc: "High school · clear but more mature",
    tier: "secondary",
  },
];
...
export const SITUATION_CONFLICTS: SituationConflict[] = [
  {
    ...
    reason:
      "Good news and a concern in one email muddles the message — recipients often miss the concern.",
  ...
  },
  {
    ...
    reason:
      "A grant request should never be paired with a complaint response — they need different audiences and tones.",
