...
import {
  GRADES, NY_STANDARDS, gradeIdToStdBand
} from "./shared";
...
export function LessonPlanGenerator({ onBuildWorksheets }: { onBuildWorksheets?: (payload: { name: string; raw: string; topic: string; gradeId: string }) => void } = {}) {
  const BRAND = "#CF27F5";
  const LIGHT  = "#FDF4FF";
