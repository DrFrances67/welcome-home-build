...
function TheTechSavvyTeacherAppRoot() {
  ...
  return (
    <div className="site-shell" style={{ display:"flex", flexDirection:"column", height: (activeTool === "email" || activeTool === "worksheet") ? "auto" : "100vh", minHeight: (activeTool === "email" || activeTool === "worksheet") ? "100vh" : 0, overflow: (activeTool === "email" || activeTool === "worksheet") ? "visible" : "hidden", background:"#F8F9FA", fontFamily:"'Inter','Segoe UI',sans-serif" }}>
      <style>{`
      ...
      <main id="main-content"
        ...
        style={{ flex:1, minHeight:0, overflow: activeTool==="worksheet" ? "visible" : activeTool==="email" ? "visible" : "auto", display:"flex", flexDirection:"column", outline:"none", touchAction:"pan-y" }}>
