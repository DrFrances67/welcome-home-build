  ...
  if (el.type === "instruction") {
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Instructions element — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        <div style={{ fontSize: Math.max(fs - 6, 12) * tScale(sc), fontWeight: elWeight || 600, color: "#1F2937", background: "#FEFCE8", padding: `${10 * tScale(sc)}px ${16 * tScale(sc)}px`, borderRadius: 8, borderLeft: `${5 * tScale(sc)}px solid ${gv.color}`, fontFamily: elFamily, lineHeight: 1.6, fontStyle: elStyle, textDecoration: elDecor, textAlign: elAlign }}>{el.text}</div>
  ...
  if (el.type === "text") {
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Text block — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        <p style={{ fontSize: fs * tScale(sc), fontWeight: elWeight || 500, color: "#111827", margin: 0, fontFamily: elFamily, lineHeight: 1.75, fontStyle: elStyle, textDecoration: elDecor, textAlign: elAlign }}>{el.text}</p>
        <DeleteBtn /><ResetBtn /><ResizeHandles />
      </div>
    );
  }
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Word bank element — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignContent: "flex-start", gap: 8 * scale.s, padding: `${10 * scale.s}px ${14 * scale.s}px`, background: gv.light, borderRadius: 8, border: `1.5px solid ${gv.color}25`, minHeight: el.heightOverride ? Math.max(24, el.heightOverride - 46) : undefined, boxSizing: "border-box" }}>
          {(el.words || []).map((w, i) => <span key={i} style={{ fontSize: fs * tScale(scale), fontWeight: 600, fontFamily: elFamily, padding: `${4 * tScale(scale)}px ${14 * tScale(scale)}px`, border: `1.5px solid ${gv.color}`, borderRadius: 40, background: "white", color: "#111827", lineHeight: 1.35 }}>{w}</span>)}
        </div>
        <DeleteBtn /><ResetBtn /><ResizeHandles />
      </div>
    );
  ...
  if (el.type === "matching") {
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Matching activity — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        {el.title && <p style={{ fontSize: Math.max(fs - 3, 12) * tScale(sc), fontWeight: elWeight || 700, color: "#111827", margin: `0 0 ${12 * tScale(sc)}px 0`, fontFamily: elFamily }}>{el.title}</p>}
        <div style={{ display: "grid", gridTemplateColumns: `1fr ${40 * sc.s}px 1fr`, gap: 6 * sc.s, alignItems: "center" }}>
          {(el.left || []).map((item, i) => (
            <span key={i} style={{ display: "contents" }}>
              <div style={{ fontSize: fs * tScale(sc), fontWeight: 600, fontFamily: elFamily, padding: `${6 * tScale(sc)}px ${10 * tScale(sc)}px`, border: `1.5px solid ${gv.color}`, borderRadius: 8, background: gv.light, textAlign: "center" }}>{item}</div>
              <div aria-hidden="true" style={{ borderBottom: "1.5px dashed #9CA3AF", margin: `0 ${4 * sc.s}px` }} />
              <div style={{ fontSize: fs * tScale(sc), fontWeight: 600, fontFamily: elFamily, padding: `${6 * tScale(sc)}px ${10 * tScale(sc)}px`, border: `1.5px solid ${gv.color}`, borderRadius: 8, background: gv.light, textAlign: "center" }}>{(el.right || [])[i] || ""}</div>
            </span>
          ))}
        </div>
        <DeleteBtn /><ResetBtn /><ResizeHandles />
  ...
  if (el.type === "multipleChoice") {
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Multiple choice question — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        <p style={{ fontSize: fs * tScale(sc), fontWeight: elWeight || 700, color: "#111827", margin: `0 0 ${5 * tScale(sc)}px 0`, fontFamily: elFamily, lineHeight: 1.45, fontStyle: elStyle, textDecoration: elDecor, textAlign: elAlign }}>{el.question}</p>
        {el.note && <p style={{ fontSize: Math.max(fs - 7, 11) * tScale(sc), fontWeight: 500, color: "#6B7280", margin: `0 0 ${12 * tScale(sc)}px 0`, fontFamily: F }}>{el.note}</p>}
        ...
        {(el.statements || []).map((stmt, i) => (
          <div key={i} style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", columnGap: 10 * scale.s, rowGap: 6 * scale.s, marginBottom: 10 * scale.s, padding: `${8 * scale.s}px ${12 * scale.s}px`, background: gv.light, borderRadius: 8, minHeight: el.heightOverride ? Math.max(34, (el.heightOverride - 42) / Math.max(1, (el.statements || []).length)) : undefined, boxSizing: "border-box" }}>
            ...
            <div style={{ display: "flex", gap: 6 * scale.s, flexShrink: 0, marginLeft: "auto" }}>
              {["TRUE", "FALSE"].map(t => <span key={t} style={{ fontSize: Math.max(fs - 6, 10) * tScale(scale), fontWeight: 700, padding: `${3 * tScale(scale)}px ${10 * tScale(scale)}px`, border: `1.5px solid ${gv.color}`, borderRadius: 40, fontFamily: F, color: gv.color, textAlign: "center", whiteSpace: "nowrap" }}>{t}</span>)}
            </div>
          </div>
        ))}
        <DeleteBtn /><ResetBtn /><ResizeHandles />
  ...
  if (el.type === "shortAnswer") {
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Short answer question — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        <p style={{ fontSize: fs * tScale(sc), fontWeight: elWeight || 700, color: "#111827", margin: `0 0 ${12 * tScale(sc)}px 0`, fontFamily: elFamily, lineHeight: 1.45, fontStyle: elStyle, textDecoration: elDecor, textAlign: elAlign, ...lineStyle }}>{el.question}</p>
  ...
  if (el.type === "fillBlank") {
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Fill in the blank activity — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        {el.note && <p style={{ fontSize: Math.max(fs - 7, 11) * tScale(sc), fontWeight: 500, color: "#6B7280", margin: `0 0 ${8 * tScale(sc)}px 0`, fontFamily: F }}>{el.note}</p>}
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Essay prompt — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 * sc.s }}>
          <p style={{ fontSize: fs * tScale(sc), fontWeight: elWeight || 700, color: "#111827", margin: 0, fontFamily: elFamily, lineHeight: 1.45, flex: 1, minWidth: 0, fontStyle: elStyle, textDecoration: elDecor, textAlign: elAlign, ...lineStyle }}>{el.prompt}</p>
          {el.points && <span style={{ fontSize: Math.max(fs - 6, 10) * tScale(sc), fontWeight: 700, color: gv.color, whiteSpace: "nowrap", marginLeft: 12 * tScale(sc), fontFamily: F, padding: `${3 * tScale(sc)}px ${9 * tScale(sc)}px`, border: `1.5px solid ${gv.color}`, borderRadius: 40 }}>{el.points} pts</span>}
        </div>
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="group" tabIndex={0} aria-label={`${el.type === "successCriteria" ? "Success criteria" : "Exit ticket"} — click to edit`} onKeyDown={e => e.key === "Enter" && onClick()}>
        <div style={{ background: bg, border: `2px solid ${accent}45`, borderLeft: `${6 * sc.s}px solid ${accent}`, borderRadius: 10, padding: `${12 * sc.s}px ${16 * sc.s}px`, height: el.heightOverride ? "100%" : undefined, boxSizing: "border-box", display: "flex", flexDirection: "column" }}>
          {el.title && <p style={{ fontSize: Math.max(fs - 2, 13) * tScale(sc), fontWeight: 800, color: accent, margin: `0 0 ${6 * tScale(sc)}px 0`, fontFamily: FF, letterSpacing: 0.2 }}>{el.title}</p>}
          {el.intro && <p style={{ fontSize: Math.max(fs - 4, 11) * tScale(sc), fontWeight: 600, color: "#374151", margin: `0 0 ${10 * tScale(sc)}px 0`, fontFamily: F, lineHeight: 1.5 }}>{el.intro}</p>}
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: itemGap, flex: 1, justifyContent: extraV > 0 ? "space-around" : "flex-start" }}>
            {(el.items || []).map((item, i) => (
              <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10 * sc.s }}>
                ...
                <span style={{ fontSize: fs * tScale(sc), fontWeight: elWeight || 600, color: "#111827", fontFamily: elFamily, lineHeight: 1.45, fontStyle: elStyle, textDecoration: elDecor, textAlign: elAlign, flex: 1, minWidth: 0, ...lineStyle }}>{item}</span>
              </li>
            ))}
          </ul>
        </div>
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="group" tabIndex={0} aria-label="DOK Questions — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        <div style={{ background: "#FFFFFF", border: `2px solid ${gv.color}45`, borderLeft: `${6 * sc.s}px solid ${gv.color}`, borderRadius: 10, padding: `${12 * sc.s}px ${16 * sc.s}px`, height: el.heightOverride ? "100%" : undefined, boxSizing: "border-box", display: "flex", flexDirection: "column" }}>
          {el.title && <p style={{ fontSize: Math.max(fs - 2, 13) * tScale(sc), fontWeight: 800, color: gv.color, margin: `0 0 ${6 * tScale(sc)}px 0`, fontFamily: FF, letterSpacing: 0.2 }}>{el.title}</p>}
          {el.intro && <p style={{ fontSize: Math.max(fs - 4, 11) * tScale(sc), fontWeight: 600, color: "#374151", margin: `0 0 ${10 * tScale(sc)}px 0`, fontFamily: F, lineHeight: 1.5 }}>{el.intro}</p>}
            ...
            {(el.levels || []).map((lv, li) => {
              ...
              return (
                <div key={li} style={{ background: c + "10", border: `1.5px solid ${c}55`, borderRadius: 8, padding: `${8 * sc.s}px ${10 * sc.s}px` }}>
                  <p style={{ fontSize: Math.max(fs - 4, 11) * tScale(sc), fontWeight: 800, color: c, margin: `0 0 ${6 * tScale(sc)}px 0`, fontFamily: FF }}>
  ...
  if (el.type === "table") {
    ...
    return (
      <div className="ws-element" style={wrap} onPointerDown={handleMouseDown} onClick={onClick} role="button" tabIndex={0} aria-label="Table element — click to edit" onKeyDown={e => e.key === "Enter" && onClick()}>
        {el.title && <p style={{ fontSize: Math.max(fs - 3, 12) * tScale(sc), fontWeight: elWeight || 700, color: "#111827", margin: `0 0 ${8 * tScale(sc)}px 0`, fontFamily: elFamily }}>{el.title}</p>}
