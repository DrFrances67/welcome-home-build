    ...
    <Html lang="en" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>Someone reached out via the {SITE_NAME} contact form.</Text>
...
export const template = {
  ...
  subject: (data: Record<string, unknown>) => `📬 Contact form: ${(data?.subject as string) || "New message"}`,
